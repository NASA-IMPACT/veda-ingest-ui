export const collectionIngestResponse = {
  ...
  links: [
    {
      href: 'https://openveda.cloud/api/stac/collections/GPM_3IMERGDF/items',
      rel: 'items',
    ...
    {
      href: 'https://openveda.cloud/api/stac/collections/GPM_3IMERGDF',
      rel: 'self',
      type: 'application/json',
    },
    {
      href: 'https://openveda.cloud/api/stac/collections/GPM_3IMERGDF/queryables',
