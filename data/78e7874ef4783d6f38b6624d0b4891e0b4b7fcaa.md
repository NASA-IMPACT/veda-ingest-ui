...
Locator: getByLabel('Band (B)')
Expected: visible
Received: undefined
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByLabel('Band (B)')

    at /home/runner/work/veda-ingest-ui/veda-ingest-ui/__tests__/playwright/COGViewerDrawer.test.tsx:63:49
    at /home/runner/work/veda-ingest-ui/veda-ingest-ui/__tests__/playwright/COGViewerDrawer.test.tsx:54:5
```
  ...
  - tabpanel "Form":
    - group:
      ...
      - group:
        ...
        - textbox "Start Date": 2025-06-17T00:00:00.000Z
        - text: End Date
        - textbox "End Date": 2025-06-17T23:59:59.000Z
      - group:
...
- dialog:
  - button "Close":
    - img "close"
  - text: COG Rendering Options Band (R)
  - combobox "Band (R)"
  ...
  - text: Colormap
  - combobox "Colormap"
  - text: rdbu Color Formula
  - textbox "Color Formula": test123
  - text: Resampling
  - combobox "Resampling"
  - text: Nearest Nodata Value
  - button "Increase Value":
    - img "up"
  - button "Decrease Value":
    - img "down"
  - spinbutton "Nodata Value": "255"
  ...
  - button "Cancel"
  - button "Accept Render Options"
- img "check-circle"
- text: COG metadata loaded successfully!
- img "check-circle"
- text: COG tile layer loaded successfully!
```
...
>  63 |       await expect(page.getByLabel('Band (B)')).toBeVisible();
  ...
  124 |     page,
  125 |   }, testInfo) => {
  126 |     await test.step('navigate to create ingest page', async () => {
  127 |       await page.goto('/create-ingest');
  128 |     });
  129 |
  ...
  148 |       );
  149 |
  150 |       await expect(page.locator('[data-testid="colorFormula"]')).toHaveValue(
  151 |         ''
  152 |       );
  153 |
  154 |       await expect(page.locator('[data-testid="nodata"]')).toHaveValue('');
  155 |     });
  156 |
  157 |     const defaultControlsScreenshot = await page.screenshot();
  158 |     testInfo.attach('Default state of COG Viewer Form Controls', {
  159 |       body: defaultControlsScreenshot,
  160 |       contentType: 'image/png',
  161 |     });
  162 |
  163 |     await test.step('validate that Rendering Options Modal displays default values in form in pretty json format', async () => {
```