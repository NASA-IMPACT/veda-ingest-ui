...
Call log:
  ...
  - fonts loaded
    ...
    at /home/runner/work/veda-ingest-ui/veda-ingest-ui/__tests__/playwright/COGViewerDrawer.test.tsx:36:49
```
  ...
  - tabpanel "Form":
    - group:
      ...
      - group:
        ...
        - textbox "Start Date": 2025-05-30T00:00:00.000Z
        - text: End Date
        - textbox "End Date": 2025-05-30T23:59:59.000Z
      - group:
        - text: "* Discovery Items"
        - group:
          - text: "* Discovery Items-1 Discovery"
          - combobox "Discovery"
          - text: "* Prefix"
          - textbox "* Prefix"
          - text: "* Bucket"
